About sagemaker-core-feedstock
==============================
...
pixi add sagemaker-core
# for installing globally
pixi global install sagemaker-core
```
...
It is possible to list all of the versions of `sagemaker-core` available on your platform:
...
```
pixi search sagemaker-core --channel conda-forge
```
